...
public class PathGraph {
    ...
    public PathNode getNearestNode(Vector2 position) {
        PathNode nearest = new PathNode(new Vector2(Integer.MAX_VALUE, Integer.MAX_VALUE), false);
    ...
    private float heuristicAndPathCost(PathNode current, PathNode goal, PathNode next, float currentPathCost) {
        ...
        float path_cost = pathCost(currentPathCost, current, next);
        return heuristic + path_cost;
    }
